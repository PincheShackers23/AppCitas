...
namespace AppCitas.UnitTests.Tests
{
    public class MessagesControllerTests
    {
        ...
        [Theory]
        [InlineData("BadRequest", "rosa", "Pa$$w0rd", "rosa","Hola amigo")]
        ...
        [Theory]
        [InlineData("NotFound", "lisa", "Pa$$w0rd", "iwata", "Hola dios")]
        ...
        [Theory]
        [InlineData("OK", "todd", "Pa$$w0rd", "esmeralda", "Hola friend")]
        ...
        [Theory]
        [InlineData("OK", "rosa", "Pa$$w0rd", "Outbox")]
        ...
        [Theory]
        [InlineData("OK", "todd", "Pa$$w0rd", "louise", "Hola jaja")]
        ...
        [Theory]
        [InlineData("Unauthorized", "lisa", "Pa$$w0rd", "tanner", "Hola", "caroline")]
